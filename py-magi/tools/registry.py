...
_BUILTIN_TOOLS: tuple[BuiltinTool, ...] = (
    ...
    ("tools.memory.conversations.search_conversation_messages", "SearchConversationMessagesTool"),
    ("tools.memory.conversations.search_contact_messages", "SearchContactMessagesTool"),
