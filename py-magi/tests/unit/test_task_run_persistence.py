...
from old_bus.firmwares.books.local.contactBook import Contact, Role
from old_bus.firmwares.books.local.tasksBook import Task, TaskBook, TaskRunBook
...
def factory():
    ...
    from old_bus.firmwares.books.local.contactBook import ContactBook  # noqa: F401
    from old_bus.firmwares.books.local.conversationBook import ConversationBook  # noqa: F401
    from old_bus.firmwares.books.magis.membershipBook import MagisMembershipBook  # noqa: F401
...
class TestReapStale:
    def test_flips_stuck_running_rows_to_failed(self, task_book, task_run_book):
        ...
        from old_bus.firmwares.books.local.tasksBook import _TaskRunRow
