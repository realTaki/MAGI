...
@dataclass
class RunTaskNotifyJob(BaseJob):
...
class RunTaskNotifyJobRow(BaseJobRow):
...
class RunTaskNotifyJobBoard(
    BaseJobBoard[RunTaskNotifyJob, RunTaskNotifyResult, RunTaskNotifyJobRow]
):
    job_cls = RunTaskNotifyJob
    result_cls = RunTaskNotifyResult
    row_cls = RunTaskNotifyJobRow
