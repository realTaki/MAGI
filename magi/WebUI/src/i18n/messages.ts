...
const zh: Catalog = {
  ...
  settings: {
    ...
    navChannels: "通道",
    navPersona: "Persona",
    navTgRead: "TG 已读 emoji",
    navTgDone: "TG 完成 emoji",
    navTz: "系统时区",
    ...
    tgDoneEmojiDesc: "TG bot 在 assistant 回复落地后再发一次 emoji，覆盖之前那个「已读」反应 — Telegram 会自动替换同一 bot 在同一消息上的 emoji。",
    ...
    tgReactionDefaultHint: "未配置时用默认",
    tgReactionDefaultHintTail: "。",
    tgReactionSavedNotice: "已保存。下一条 TG 消息就会用新的 emoji。",
  },
  topbar: {
    signedInAs: "已登录为",
    signOut: "退出登录",
...
const en: Catalog = {
  ...
  settings: {
    ...
    tgDoneEmojiDesc: "The “done” emoji the TG bot sends after the assistant reply lands — it overwrites the read reaction on the same message; Telegram dedupes bot reactions per chat+message.",
    ...
    tgReactionDefaultHint: "Default when unset:",
    tgReactionDefaultHintTail: ".",
    tgReactionSavedNotice: "Saved. The next TG message will use the new emoji.",
  },
  topbar: {
...
const ja: Catalog = {
  ...
  settings: {
    ...
    tgDoneEmojiDesc: "アシスタントの返信が到着した後、TG bot が同じメッセージに送る「完了」絵文字 — Telegram は同じ bot の同じメッセージへのリアクションを自動的に置き換えます。",
    ...
    tgReactionDefaultHint: "未設定時のデフォルト:",
    tgReactionDefaultHintTail: "。",
    tgReactionSavedNotice: "保存しました。次の TG メッセージから新しい絵文字が使われます。",
  },
  topbar: {
    signedInAs: "ログイン中",
    signOut: "サインアウト",
