/**
 * SidebarShell — the two-column "slate-900 sidebar + light
 ...
 *
 * The shell owns the outer container, the dark sidebar column,
 * and the light content pane. The caller owns:
 ...
 *     same dark column — used by the Chat tab to stack a
...
export default function SidebarShell(props: {
  ...
  /** Optional slot rendered below the nav items, inside the dark
  ...
  return (
    <div className="rounded-2xl bg-white/80 backdrop-blur-md shadow-lg shadow-sky-900/5 border border-white/60 overflow-hidden">
      <div className="flex min-h-[420px]">
        <nav
          className="w-56 shrink-0 bg-slate-900 text-slate-100 p-3 flex flex-col"
