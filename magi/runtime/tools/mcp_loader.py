...
existing :mod:`magi.runtime.tools` registry.
...
logger = logging.getLogger("magi.runtime.tools.mcp_loader")
...
# :mod:`magi.runtime.tools.base`, which we don't import at the
...
def _mcp_tool_result(*, success: bool, content: str, error: str | None) -> Any:
    ...
    """
    from magi.runtime.tools.base import ToolResult
    if success:
...
def load_mcp_tools_blocking(
    ...
    *,
    ...
    (see :func:`magi.runtime.tools.registry.bootstrap_mcp_tools`).
