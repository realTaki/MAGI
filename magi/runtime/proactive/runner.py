...
2. Creates a brand-new :class:`ChatSession` plus a
   ...
   prompt.
3. Calls :func:`magi.runtime.agent.handle_message` with the
...
:class:`magi.runtime.proactive.scheduler.TaskScheduler`)
...
from magi.runtime.sessions import new_session_id, utcnow_iso
from magi.runtime.state.orm import ActionItem, ChatMessage, ChatSession, Employee, TokenUsage, open_session
from magi.runtime.state.settings import state_get

logger = logging.getLogger("magi.runtime.proactive.runner")
