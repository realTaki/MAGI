...
- `magi/runtime/agent.py` — chat turn 主入口
- `magi/runtime/tools/registry.py` — 内置工具枚举
- `magi/runtime/state/orm.py` — SQLAlchemy tables
- `magi/channels/webui/api/` — FastAPI endpoints
- `magi/runtime/skills/` — SKILL.md 装载器

## 推荐 reply 模板

> **位置**: `magi/runtime/skills/loader.py:42`
