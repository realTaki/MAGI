...
logger = logging.getLogger("magi.runtime.skills.loader")
...
class SkillMeta:
    ...
    read on demand by :class:`magi.runtime.skills.loader_tool.SkillLoaderTool`.
    """
...
def _workspace_root() -> Path:
    """Mirror :func:`magi.runtime.workspace.workspace_root` — we
