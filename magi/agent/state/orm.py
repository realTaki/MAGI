...
logger = logging.getLogger("magi.agent.state.orm")
...
class ChatSession(Base):
    ...
    :class:`magi.agent.sessions.SessionStore.get`.
    """
...
def init_orm(state_dir: str | None = None) -> Engine:
    ...
    import magi.agent.proactive.orm_models  # noqa: F401 — registers on Base
...
def get_session() -> Generator[Session, None, None]:
    ...
    Usage in a route::
        ...
        from magi.agent.state.orm import get_session
